window.I18N = {
  ko: {
    ...
    tabBS: "재무상태표",
    tabCF: "현금흐름표",
    plKrExtraHeading: "필수 입력 — 인원수 · 접대비 · 출장비",
    plKrExtraNote: "본사에 보고하는 한국회계기준 영업이익(영업이익 계정)의 기준 자료입니다. 인원수, 접대비 월간 합계(접대비 앱 기준), 출장비 월간 합계를 함께 입력해주세요. 세 항목을 모두 채워야 제출할 수 있습니다.",
    plKrExtraMissing: "인원수 · 접대비 월간 합계 · 출장비 월간 합계를 모두 입력해야 제출할 수 있습니다.",
    plKrBackfillNote: "제출이 잠긴 뒤에도 아직 비어 있는 항목은 아래 버튼으로 보완 입력할 수 있습니다. 이미 제출한 금액과 이미 입력된 항목은 변경되지 않습니다.",
    plKrBackfillBtn: "부가정보만 저장",
    plKrBackfillSuccess: "부가정보를 저장했습니다.",
    headcountLabel: "인원수",
  ...
  zh: {
    ...
    tabBS: "资产负债表",
    tabCF: "现金流量表",
    plKrExtraHeading: "必填 — 人员数 · 招待费 · 差旅费",
    plKrExtraNote: "此为向总部报告的韩国会计准则营业利润(营业利润科目)的基础数据。请一并填写人员数、当月招待费合计(以招待费应用为准)和当月差旅费合计。三项全部填写后方可提交。",
    plKrExtraMissing: "请填写人员数、当月招待费合计和当月差旅费合计后再提交。",
    plKrBackfillNote: "锁定后仍可通过下方按钮补录尚未填写的项目。已提交的金额和已填写的项目不会被修改。",
    plKrBackfillBtn: "仅保存附加信息",
    plKrBackfillSuccess: "附加信息已保存。",
    headcountLabel: "人员数",
